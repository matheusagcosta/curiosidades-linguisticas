...
function randomCuriosity() {
  ...
  var textName = document.getElementById("textName").innerHTML = "".concat(contentCalc.split(' ')[0]);
  var textContent = document.getElementById("textDesc").innerHTML = "".concat(" " + contentCalc.split(' ').slice(1).join(' '));
  var backGroundChange = document.getElementById("container").style.backgroundColor = "".concat(backColorCalc);
  var fontChange = document.getElementById("textDesc").style.color = "".concat(fontColorCalc);
  return;
}
...
//# sourceMappingURL=/curiosidades-linguisticas.e31bb0bc.js.map
...
function randomCuriosity() {
  ...
  textName = document.getElementById("textName").innerHTML = "".concat(contentCalc.split(' ')[0]);
  textContent = document.getElementById("textDesc").innerHTML = "".concat(" " + contentCalc.split(' ').slice(1).join(' '));
  backGroundChange = document.getElementById("container").style.backgroundColor = "".concat(backColorCalc);
  fontChange = document.getElementById("textDesc").style.color = "".concat(fontColorCalc);
}
...
},{"./js/scripts.js":"js/scripts.js","./js/html2canvas.min.js":"js/html2canvas.min.js"}],"../../../../usr/local/share/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {

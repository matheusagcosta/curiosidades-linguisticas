...
exports.randomCuriosity = randomCuriosity;

var _contents = require("../data/contents.json");

var _colors = require("../data/colors.json");

function randomCuriosity() {
  var colorCalc = parseInt(Math.random() * _colors.backColor.length);
  var textCalc = parseInt(Math.random() * _contents.contents.length);
  var backColorCalc = _colors.backColor[colorCalc];
  var fontColorCalc = _colors.fontColor[colorCalc];
  var contentCalc = _contents.contents[textCalc];
  document.getElementById("textDesc").innerHTML = "".concat(contentCalc);
  document.getElementById("container").style.backgroundColor = "".concat(backColorCalc);
  document.getElementById("textDesc").style.color = "".concat(fontColorCalc);
  return;
}
},{"../data/contents.json":"data/contents.json","../data/colors.json":"data/colors.json"}],"node_modules/html2canvas/dist/html2canvas.js":[function(require,module,exports) {
var define;
...
},{}],"js/takeShot.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.takeShot = takeShot;
...
function takeShot() {
  (0, _html2canvas.default)(document.getElementById('container')).then(function (canvas) {
    var url = canvas.toDataURL("image/png");
    var screenDown = document.getElementById("screen__preview");
    screenDown.href = url;
    screenDown.click();
  });
}
...
//# sourceMappingURL=/curiosidades.e31bb0bc.js.map